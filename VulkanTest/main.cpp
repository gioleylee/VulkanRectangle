...
private:
    ...
    void createGraphicsPipeline() {
        ...
        pipelineInfo.stageCount = 2; // vertex & fragment shader stages
    ...
    void createIndexBuffer() {
        ...
        createBuffer(bufferSize, VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_INDEX_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT |
            VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, indexBuffer, indexBufferMemory);
    ...
    void createSyncObjects() {
        ...
        fenceInfo.flags = VK_FENCE_CREATE_SIGNALED_BIT; // avoids error in startup
